                    ...
                    <template v-slot:default>
                        ...
                        <tbody>
                            ...
                            >
                              ...
                              <td>
                                <v-icon small @click="editHandler(jadwal)" color="primary">mdi-pencil</v-icon>
                                ...
                                <!-- <v-btn small @click="editHandler(item)">
                                  <v-icon small @click="editHandler(item)" color="#E39348">mdi-pencil</v-icon>
                                </v-btn>
                                <v-btn small @click="deleteHandler(item.id_jadwal_rutin_pangkalan)">
                                  <v-icon small @click="deleteHandler(item.id_jadwal_rutin_pangkalan)" color="#E39348">mdi-delete</v-icon>
                                </v-btn> -->
                                  <!-- <v-list-item>
                                    <v-list-item-content>
...
export default {
  ...
  methods: {
    ...
    updateTemp() {
      var url = this.$api + "/jadwalRutinPangkalanTemp";
      this.load = true;
      this.$http
        .put(url, {
          headers: {
