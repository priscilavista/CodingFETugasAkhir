                                                ...
                                                <v-container class="grey lighten-5">
                                                    ...
                                                    <v-row no-gutters>
                                                        ...
                                                        >
                                                            ...
                                                            style="text-align:left;"
                                                            >
                                                            <strong style="margin-left:5px">Driver</strong>
                                                            </v-card>
                                                        </v-col>
                                                        <v-col
                                                            cols="6"
                                                        ...
                                                        >
                                                            ...
                                                            style="text-align:left;"
                                                            >
                                                            <span style="margin-left:5px">{{ event.nama_driver }}</span>
                                                            </v-card>
                                                        </v-col>
                                                    </v-row>
                                                    <v-row no-gutters>
                                                        ...
                                                        >
                                                            ...
                                                            style="text-align:left;"
                                                            >
                                                            <span style="margin-left:5px">{{ event.alokasi_penerimaan_gas }}</span>
                                                            </v-card>
                                                        </v-col>
                                                    </v-row>
                                                </v-container>
...
export default {
    ...
    data() {
        return{
            ...
            events: [
                {
                    alokasi_penerimaan_gas: 2000,
                    id_driver: 1,
                    nama_driver: 'Going to the beach!',
                    tanggal_pengambilan_gas: new Date().toISOString().slice(0, 10),
                    alokasi_tambahan: 50,
                    total_alokasi_penerimaan_gas: 2050,
                    jenis_alokasi: 'R',
                },
            ],
            events2: [
